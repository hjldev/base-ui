...
import { getPermissionTree, getPermissionIdsByRole } from '@/api/permission'
import { getMenusTree, getMenusByRole } from '@/api/menu'
  ...
  methods: {
    ...
    handleCurrentChange(val) {
      if (val) {
        ...
        getPermissionIdsByRole(val).then(permissionIds => {
          // 处理权限数据
          permissionIds.forEach(function(data, index) {
